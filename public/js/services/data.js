angular.module('mean.system').factory('Data',['$stateParams', function($stateParams){
	...
	var brands = {
		television: ['aqualite','bush','cello','e-motion','lg','panasonic','toshiba','philips','sharp','samsung', 'jvc','sony','hitachi','digihome','logik','sandstrom','jmb','luxor','blaupunkt','foehn & hirsch','furrion','goodmans','hannspree','technika'],
